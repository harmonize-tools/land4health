...
- [`l4h_forest_loss()`](https://github.com/harmonize-tools/land4health/reference/l4h_forest_loss.md)
  **\[stable\]** : Extracts forest cover loss within a defined polygon
- [`l4h_night_lights()`](https://github.com/harmonize-tools/land4health/reference/l4h_night_lights.md)
  **\[stable\]** : Extracts global night‑time lights using harmonized
  DMSP‑OLS and VIIRS data
- [`l4h_urban_rural_area()`](https://github.com/harmonize-tools/land4health/reference/l4h_urban_rural_area.md)
  **\[experimental\]** : Extracts surface areas by urban and rural
  categories from GHS-SMOD
...
- [`l4h_era5land()`](https://github.com/harmonize-tools/land4health/reference/l4h_era5land.md)
  **\[experimental\]** : Extract ERA5-Land climate variables from Google
  Earth Engine
