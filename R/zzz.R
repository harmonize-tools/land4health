  ...
  if (interactive() && !isTRUE(getOption("land4health.shownWelcome"))) {
    ...
    cli::cli_text("{.emph A tool of the {.href [{.pkg Harmonize Project}](https://www.innovalab.info/harmonize)} to calculate and extract Remote Sensing Metrics for Spatial Health Analysis.}")
