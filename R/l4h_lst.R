...
#' lst_day <- l4h_lst(from = "2020-01-01", to = "2020-12-31",
#'                    region = region, band = "day", stat = "mean")
#' head(lst_day)
#'
#' # Extract nighttime LST
#' lst_night <- l4h_lst(from = "2020-01-01", to = "2020-12-31",
...
l4h_lst <- function(from, to, region, band = "day", level = "strict", scale = 1000, stat = "mean", sf = TRUE, quiet = FALSE, force = TRUE, ...){
  # Dataset date range
