...
#'   data_type = "national", region = "paho",
#'   country = "peru", cache = TRUE, quiet = TRUE
#' )
#' head(df_nat)
#'
...
#'   data_type = "spatial", region = "Pan-American Region",
#'   country = "brazil", cache = TRUE, quiet = FALSE
#' )
#' head(df_spat)
#'
...
#'   data_type = "temporal", region = "PAHO",
#'   country = "Argentina", cache = TRUE, quiet = TRUE
#' )
#' head(df_temp)
#' }
#' @export
